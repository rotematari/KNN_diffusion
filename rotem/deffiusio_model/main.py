...
import utils
import model
from model import SimpleUnet,build_resunet
...
parser.add_argument('--lr', type=int,default=0.004 ,help='epochs')
parser.add_argument('--weight_decay', type=int,default=0.0005 ,help='epochs')

#deffiusion args
parser.add_argument('--time_emb_dim', type=int,default=32 ,help='noising times') 
parser.add_argument('--T', type=int,default=500 ,help='noising times')
